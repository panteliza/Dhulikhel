        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg w-full">
            <h2 className="text-2xl font-bold text-gray-800 mb-4 text-center">
              Contact Dhulikhel Boutique Hotel
            </h2>
            {messageSent ? (
          ...
          <div className="text-white text-center md:text-left flex flex-col justify-center">
            <h1 className="text-4xl font-bold mb-4">Dhulikhel Boutique Hotel</h1>
            <p className="text-lg leading-relaxed mb-4">
              Discover tranquility and elegance at Dhulikhel Boutique Hotel. Immerse yourself in breathtaking mountain views, luxurious accommodations, and warm Nepali hospitality.
            </p>
